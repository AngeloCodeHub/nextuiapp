      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-200 px-6 py-10 md:w-2/5 md:px-20">
          ...
          <p className={`text-xl text-gray-800 md:text-3xl md:leading-normal ${lusitana.className} antialiased`}>
            <strong>歡迎光臨北半球</strong> This is the 範例 for the{' '}
          ...
          >
            <span>登錄</span> <ArrowRightIcon className="w-5 md:w-6" />
          </Link>
        </div>
        <div className="flex items-center justify-center p-6 md:w-3/5 md:px-28 md:py-12">
          <Image
            src="/hero-desktop.png" alt="Screenshots of the dashboard project showing desktop version"
            width={1000} height={760} className="hidden md:block"
          >
          </Image>
          <Image
            src="/hero-mobile.png" alt="Screenshots of the dashboard project showing mobile version"
